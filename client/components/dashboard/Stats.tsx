...
function Stats() {
    ...
    return (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8 stagger">
            ...
            <div className="bg-[#13141d] border border-white/5 rounded-2xl p-4 md:p-5 flex items-center flex-wrap gap-4">
                ...
                <div>
                    ...
                    <p className="text-white font-semibold text-xs md:text-sm">2/8 done</p>
                </div>
            </div>

            {statsData.map((item) => (
                <div key={item.title} className="bg-[#13141d] border border-white/5 rounded-2xl p-3 md:p-5">
                    <p className="text-slate-500 text-[7px] md:text-xs uppercase tracking-wider mb-2">{item.title}</p>
